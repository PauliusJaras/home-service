...
router.post("/register", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.body;
        const existingUser = yield userSchema_1.default.findOne({ email: user.email });
        if (existingUser) {
...
router.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userWithoutPassword = yield userSchema_1.default.findById(user._id).select("-password");
        return res
            .status(200)
