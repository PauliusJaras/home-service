...
const businessSchema_1 = __importDefault(require("../schemas/businessSchema"));
const bookingSchema_1 = __importDefault(require("../schemas/bookingSchema"));
const authMiddleware_1 = __importDefault(require("../middlewares/authMiddleware"));
const router = express_1.default.Router();
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const businesses = yield businessSchema_1.default.find();
        res.json(businesses);
    }
    catch (err) {
...
router.post("/", authMiddleware_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const categoryExists = yield categorySchema_1.default.findOne({ name: business.category });
        if (!categoryExists) {
            return res.status(400).json({
                message: "Failed to add business: specified category does not exist.",
            });
        }
        const newBusiness = new businessSchema_1.default(business);
...
router.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const business = yield businessSchema_1.default.findById(req.params.id);
        if (business) {
            res.json(business);
        }
        else {
...
router.get("/category/:category", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const filteredBusinesses = yield businessSchema_1.default.find({
...
router.get("/:id/bookings/date/:date", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const slots = yield bookingSchema_1.default.find({
